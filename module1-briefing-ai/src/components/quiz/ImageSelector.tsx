...
import type { QuizPair, SelectedImage } from '@/lib/types'
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="w-full"
      >
        <h2 className="text-center text-xl font-semibold text-stone-800 mb-6">
          {pair.question}
        </h2>
        ...
        <p className="text-center text-sm text-stone-400 mt-4">
          Chọn hình ảnh khiến bạn cảm thấy muốn ở trong đó hơn
        </p>
      </motion.div>
    </AnimatePresence>
  )
