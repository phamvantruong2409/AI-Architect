...
import { analyzeRegulatory } from '@/lib/gemini'
import type { CheckFormData } from '@/lib/types'
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const userMsg = isQuota
      ? 'Gemini API hết quota (429). Vui lòng kiểm tra GEMINI_API_KEY tại aistudio.google.com và cập nhật .env.local.'
  ...
  // 4. Update check status → completed
