...
import { SEVERITY_CONFIG, CATEGORY_LABELS } from '@/lib/utils'
  ...
  return (
    <div className={`border rounded-2xl p-5 space-y-3 ${cfg.bg} ${cfg.border}`}>
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <span className={`text-xs px-2.5 py-1 rounded-full font-semibold shrink-0 ${cfg.bg} ${cfg.text} border ${cfg.border}`}>
          {cfg.label}
        </span>
      </div>
