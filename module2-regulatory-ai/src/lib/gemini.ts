...
import type { RegCheck, RegReport } from './types'
import {
  getSetbackRule,
  MAX_DENSITY,
  MAX_FAR,
...
Quy tắc severity:
- error: Vi phạm nghiêm trọng, không được phép xây dựng nếu không sửa
- warning: Cần xem xét, có thể xin ngoại lệ hoặc cần làm rõ thêm
- info: Lưu ý, khuyến nghị cải thiện nhưng không bắt buộc
